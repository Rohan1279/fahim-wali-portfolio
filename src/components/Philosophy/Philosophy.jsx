    ...
    <div className="h-fit flex justify-center gap-x-[286px] pl-[103px] pr-[176px] pt-[127px] pb-[154px]">
      ...
      <div className="h-fit w-[389px] font-poppins text-[#A67458] font-medium mt-[3px] text-[14px] ">
        <p className="mb-6 ">
          ...
          artistic integrity drives me to continually push boundaries and evolve
          as a designer.
        </p>
        <p>
          In essence, my work aims to carry forward Bass&apos;s legacy of
          innovation, simplicity, and visual impact. By channeling his spirit of
          curiosity and audacity, I hope to create timeless designs that
